...
public enum SwiftyWeiboError: Swift.Error {
...
extension SwiftyWeiboError: LocalizedError {
    public var errorDescription: String? {
        ...
        case .dataMapping:
            return "Failed to map data to a data."
        case .stringMapping:
